                ...
                <table className="w-full text-sm">
                  <thead className="bg-muted/50 sticky top-0">
                    <tr>
                      ...
                      <th className="text-right p-2 font-medium">{t('apiKeyUsage.in')}</th>
                      <th className="text-right p-2 font-medium">{t('apiKeyUsage.out')}</th>
                ...
                modelStats.map((stat, idx) => (
                  <div key={idx} className="bg-muted/30 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge variant="secondary">{stat.requests} {t('apiKeyUsage.requests')}</Badge>
                    </div>
                    {/* 进度条 */}
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      ...
                      <div>
                        <span className="text-muted-foreground">{t('apiKeyUsage.input')}:</span>
                        <span className="ml-2 font-mono">{stat.inputTokens.toLocaleString()}</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">{t('apiKeyUsage.output')}:</span>
                ...
                <>
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-muted/50">
                      <tr>
                        <th className="text-left p-2 font-medium">{t('apiKeyUsage.date')}</th>
                        <th className="text-right p-2 font-medium">{t('apiKeyUsage.requests')}</th>
                        <th className="text-right p-2 font-medium">Credits</th>
                        <th className="text-right p-2 font-medium">{t('apiKeyUsage.input')}</th>
                        <th className="text-right p-2 font-medium">{t('apiKeyUsage.output')}</th>
                      </tr>
                    </thead>
                    <tbody className="font-mono">
